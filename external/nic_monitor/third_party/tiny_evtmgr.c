 ...
 */
/*
 * @brief: add message to event handler.
 * @details @b #include <tiny_evtmgr.h>
 *          tem_msg should be freed by user. API isn't responsible to manage tem_msg
 * @param[]
 * @return if success TINY_EVTMGR_SUCCESS else TINY_EVTMGR_FAIL
 * @since 
 */
