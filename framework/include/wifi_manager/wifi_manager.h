 ...
 * @details @b #include <wifi_manager/wifi_manager.h>
 * @param[in] AP configuration infomation should be given including ssid, channel, and passphrase.
 * @return On success, WIFI_MANAGER_SUCCESS (i.e., 0) is returned. On failure, non-zero value is returned.
 * @since Tizen RT v1.1
 */
 ...
 * @details @b #include <wifi_manager/wifi_manager.h>
 * @param[in] The pointer of AP configuration infomation which will be filled
 * @return On success, WIFI_MANAGER_SUCCESS (i.e., 0) is returned. On failure, non-zero value is returned.
 * @since Tizen RT v1.1
 */
#endif
